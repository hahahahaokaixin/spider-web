...
public class ClientGlobal {
     ...
     * tracker_server=119.90.36.153:22122
     */
    public static void init(int connectTimeout,
                            ...
                            String key, String[] trackerServer) throws FileNotFoundException, IOException, MyException {

        String[] szTrackerServers;
        String[] parts;


        g_connect_timeout = connectTimeout;
        if (g_connect_timeout < 0) {
            g_connect_timeout = DEFAULT_CONNECT_TIMEOUT;
        }
        g_connect_timeout *= 1000; //millisecond

        g_network_timeout = networkTimeout;
        ...
        szTrackerServers = trackerServer;
        ...
        g_tracker_http_port = httpPort;
        g_anti_steal_token = antiStealToken;
